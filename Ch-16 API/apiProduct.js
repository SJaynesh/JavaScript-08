...
async function fetchAllProducts() {
    try {
        ...
        productsView.innerHTML = "<img src='images/loading.gif' width='20'/>";
...
function categoryDisplay() {
    ...
    allCategories.forEach((category) => {
        categoryView.innerHTML += `<div class="col m-2">
                <button class="btn btn-info" onclick="getCategory('${category}')">${category[0].toUpperCase() + category.slice(1)}</button>
            </div>`
    })
}
